...
public class AnguarSampleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(AnguarSampleApplicationApp.class);

    private final Environment env;

    public AnguarSampleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes AnguarSampleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AnguarSampleApplicationApp.class);
